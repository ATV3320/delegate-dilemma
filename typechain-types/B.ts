...
export interface BInterface extends utils.Interface {
  functions: {
    "contractActuallyCalled()": FunctionFragment;
    "num()": FunctionFragment;
    "sender()": FunctionFragment;
    "setVars(uint256)": FunctionFragment;
    "setVars1(uint256)": FunctionFragment;
    "setVarsNoDel(uint256)": FunctionFragment;
    "value()": FunctionFragment;
  };

  getFunction(
    nameOrSignatureOrTopic:
      | "contractActuallyCalled"
      | "num"
      | "sender"
      | "setVars"
      | "setVars1"
  ...
  encodeFunctionData(
    functionFragment: "contractActuallyCalled",
    values?: undefined
  ): string;
  ...
  encodeFunctionData(
    functionFragment: "setVars1",
    values: [PromiseOrValue<BigNumberish>]
  ): string;
  encodeFunctionData(
    functionFragment: "setVarsNoDel",
    values: [PromiseOrValue<BigNumberish>]
  ): string;
  ...
  decodeFunctionResult(functionFragment: "setVars1", data: BytesLike): Result;
  decodeFunctionResult(
    functionFragment: "setVarsNoDel",
    data: BytesLike
  ): Result;
...
export interface B extends BaseContract {
  ...
  functions: {
    contractActuallyCalled(overrides?: CallOverrides): Promise<[string]>;
  ...
  estimateGas: {
    contractActuallyCalled(overrides?: CallOverrides): Promise<BigNumber>;
